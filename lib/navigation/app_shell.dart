      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text('• Added clear permission explanations for Camera & Storage.'),
              SizedBox(height: 6),
              Text('• Redesigned Category & Account pickers for a cleaner layout.'),
              SizedBox(height: 6),
              Text('• You can now create new Categories/Accounts directly from the Transaction screen using the \'+\' button!'),
              SizedBox(height: 6),
              Text('• Improved app navigation: press back on any tab to return Home. Double-press on Home to exit.'),
              SizedBox(height: 6),
              Text('• Fixed category resetting when toggling transaction types.'),
            ],
          ),
        ),
        actions: [
