          ...
          return Column(
            ...
            children: [
              ...
              ...transactions.map((transaction) {
                ...
                Category? category;
                try {
                  category = txnCtrl.categories.firstWhere(
                    (cat) => cat.id == transaction.categoryId,
                  );
                } catch (e) {
                  category = txnCtrl.categories.isNotEmpty
                      ? txnCtrl.categories.first
                      : null;
                }
                ...
                return TransactionListItem(
                  ...
                  onEdit: () =>
                      _editTransaction(context, transaction, txnCtrl, accCtrl),
    ...
    return Container(
      ...
      child: FloatingActionButton(
        ...
        child: Container(
          ...
          child: const Icon(Icons.add_rounded, size: 32, weight: 100),
        ),
      ),
    );
  }
    ...
    var filtered = transactions.where((transaction) {
      ...
      if (_selectedFilter != 'All') {
        if (_selectedFilter == 'Income' &&
            transaction.type != AppConstants.transactionTypeIncome) {
          return false;
        }
        if (_selectedFilter == 'Expense' &&
            transaction.type != AppConstants.transactionTypeExpense) {
          return false;
        }
        if (_selectedFilter == 'Transfer' &&
            transaction.type != AppConstants.transactionTypeTransfer) {
          return false;
        }
      }
